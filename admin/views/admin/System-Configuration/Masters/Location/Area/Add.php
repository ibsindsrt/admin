					...
					<fieldset>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>AREA</label>			
									<input type="text" name="AreaName" id="area_id" placeholder="-- Select Area --" class="form-control"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>PINCODE</label>			
									<input type="text" name="Pincode" id="pincode_area_id" placeholder="-- Enter Pincode --" class="form-control"/>
								</div>
							</div>
						</div>
					</fieldset>
