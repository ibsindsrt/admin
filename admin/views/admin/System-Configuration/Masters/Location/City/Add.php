					...
					<fieldset>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>CITY</label>			
									<input type="text" name="CityName" id="city_id" placeholder="-- Enter City --" class="form-control"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>PINCODE</label>			
									<input type="text" name="Pincode" id="pincode_city_id" placeholder="-- Enter Pincode --" class="form-control"/>
								</div>
							</div>
						</div>
					</fieldset>
