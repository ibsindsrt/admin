						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>CITY</label>
									<?php foreach($a->result() as $row)?>
									<input type="text" name="CityName" id="city_id" placeholder="<?php echo $row->CityName;?>" class="form-control"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>PINCODE</label>
									<?php foreach($a->result() as $row)?>
									<input type="text" name="Pincode" id="pincode_city_id" placeholder="<?php echo $row->Pincode;?>" class="form-control"/>
								</div>
							</div>
						</div>
					</fieldset>
