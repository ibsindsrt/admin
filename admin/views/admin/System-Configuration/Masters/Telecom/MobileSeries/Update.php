						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									...
									<input type="text" name="MSeriesNo" id="MSeriesNo" class="form-control masked" data-format="99999" data-placeholder="X" placeholder="<?php echo $row->MSeriesNo;?>"/>
								</div>
							</div>
						</div>
					...
					<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									...
									<select name="MTechnology" id="MTechnology" class="form-control" placeholder="">
										<option value=""><?php echo $row->MTechnology;?></option>
							...
							<div class="form-group">
		 						<div class="col-md-4 col-sm-4">
									...
									<select name="CircleID" id="CircleID" class="form-control">
										<option value=""><?php echo $row->CName;?></option>
