						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									...
									<input type="text" name="BrandName" id="service_BrandName" placeholder="-- Enter BrandName --" class="form-control"/>
								</div>
							</div>
						</div>
					<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									<label>Code</label>										
									<input type="text" name="Code" id="service_Code" placeholder="-- Enter Code --" class="form-control"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group">
								<div class="col-md-4 col-sm-4">
									...
									<input type="text" name="ServiceProvider" id="service_ServiceProvider" placeholder="-- Enter ServiceProvider --" class="form-control"/>
								</div>
							</div>
						</div>
						<div class="row">
