...
class Minify
{
	 ...
	 * @return string
	 */
	public function deploy_css($force = FALSE, $file_name = NULL, $group = NULL)
	{
		$return = '';
	...
	private function _deploy_js($force = FALSE, $file_name = NULL, $group = NULL)
	{
		...
		return '<script type="text/javascript" src="' . base_url($this->_js_file) . '" async></script>';
	}
